...
describe("AssetLayoutComponent", () => {
  ...
  it("should have a asset-layout--grid with router-outlet in it", () => {
    ...
    const routerOutlet = layoutElement.querySelector(
      ".asset-layout--grid router-outlet"
    );
  ...
  it("should navigate when key is pressed", () => {
    ...
    let currentState = { ...initialState, asset: AssetInitialState };
    ...
    expect(navigateSpy).toHaveBeenCalledTimes(expectedTimesCalled);
    expect(navigateSpy).toHaveBeenCalledWith([
      "/asset/ba498d76-ecd1-486a-9302-728367b237a7/mobileTerminals",
    ]);
    ...
    expect(navigateSpy).toHaveBeenCalledTimes(expectedTimesCalled);
    expect(navigateSpy).toHaveBeenCalledWith([
      "/asset/ba498d76-ecd1-486a-9302-728367b237a7/contacts",
    ]);
    ...
    expect(navigateSpy).toHaveBeenCalledTimes(expectedTimesCalled);
    expect(navigateSpy).toHaveBeenCalledWith([
      "/asset/ba498d76-ecd1-486a-9302-728367b237a7/notes",
    ]);
    ...
    expect(navigateSpy).toHaveBeenCalledTimes(expectedTimesCalled);
    expect(navigateSpy).toHaveBeenCalledWith([
      "/asset/ba498d76-ecd1-486a-9302-728367b237a7/positions",
    ]);
  ...
  it("should show the correct link as active when navigating", fakeAsync(() => {
    ...
    expect(
      fixture.nativeElement.querySelector(
        ".asset-layout--grid .side-menu .active .text"
      ).textContent
    ).toBe("Asset info");
    ...
    ).toBe("Mobile terminal");

    const router = TestBed.inject(Router);
    ngZone.run(() =>
      router.navigate(["/asset/ba498d76-ecd1-486a-9302-728367b237a7/contacts"])
    );
    tick();
    currentState = {
      ...currentState,
    ...
    ngZone.run(() =>
      router.navigate(["/asset/ba498d76-ecd1-486a-9302-728367b237a7/notes"])
    );
    tick();
    currentState = {
      ...currentState,
    ...
    ngZone.run(() =>
      router.navigate(["/asset/ba498d76-ecd1-486a-9302-728367b237a7/positions"])
    );
    tick();
    currentState = {
      ...currentState,
