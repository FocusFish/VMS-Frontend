...
describe("AssetPanelComponent", () => {
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      imports: [UIModule, MatCheckboxModule],
      declarations: [AssetPanelComponent, PanelBlockComponent],
    }).compileComponents();
  }));
  ...
  const setup = () => {
    ...
    component.getAssetTrackTimeInterval = (
      historyId: string,
      startDate: number,
      endDate: number
    ) => {};
  ...
  it("should correctly toggle tracks", () => {
    ...
    const getAssetTrackTimeIntervalSpy = spyOn(
      component,
      "getAssetTrackTimeInterval"
    );
    ...
    component["getTracksMillisecondCap"] = () =>
      (1555490596000 - component.tracksMinuteCap * 60 * 1000).toString();
    ...
    expect(getAssetTrackSpy).toHaveBeenCalledWith(
      ...
      selectedAsset.currentPosition.movement.id
    );
  });
