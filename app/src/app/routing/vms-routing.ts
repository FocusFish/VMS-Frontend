...
import { ShowByAssetPageComponent as MobileTerminalsShowByAssetPage } from "@app/modules/mobile-terminal/pages/show-by-asset/show-by-asset.component";
import { AttachmentHistoryPageComponent as MobileTerminalAttachmentHistoryPage } from "@app/modules/mobile-terminal/pages/attachment-history/attachment-history.component";
...
// Admin-pages
import { PingsComponent } from "@app/modules/admin/pages/pings/pings.component";
import { ConfigurationMenuComponent } from "@app/modules/admin/components/configuration-menu/configuration-menu.component";
    ...
    children: [
      {
        ...
        data: {
          title:
            $localize`:@@ts-layout-asset-create:Assets — Create asset` ||
            "Assets — Create asset",
        },
      },
      {
        ...
        data: {
          title:
            $localize`:@@ts-layout-asset-edit:[[[assetName]]] — Edit asset` ||
            "Edit asset",
        },
      },
      {
        path: "asset/:assetId/mobileTerminals",
        component: MobileTerminalsShowByAssetPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-mobile-terminals:[[[assetName]]] — Mobile Terminals` ||
            "Mobile Terminals",
        },
      },
      {
        ...
        data: {
          title:
            $localize`:@@ts-layout-asset-info:[[[assetName]]] — Asset information` ||
            "Asset information",
        },
      },
      {
        ...
        data: {
          title:
            $localize`:@@ts-layout-asset-search:Assets — Asset search` ||
            "Asset search",
        },
      },
      {
        path: "asset/:assetId/mobileTerminal/attach",
        component: MobileTerminalAttachPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-mobileTerminal-attach:[[[assetName]]] — Attach Mobile Terminal` ||
            "Attach Mobile Terminal",
        },
      },
      {
        path: "asset/:assetId/mobileTerminal/create",
        component: MobileTerminalFormPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-mobileTerminal-create:[[[assetName]]] — Mobile Terminal` ||
            "Create Mobile Terminal",
        },
      },
      {
        path: "asset/:assetId/mobileTerminal/:mobileTerminalId/edit",
        component: MobileTerminalFormPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-mobileTerminal-edit:[[[assetName]]] — Mobile Terminal` ||
            "Edit Mobile Terminal",
        },
      },
      {
        path: "asset/:assetId/contacts",
        component: ContactShowByAssetPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-contacts:[[[assetName]]] — Contacts` ||
            "Contacts",
        },
      },
      {
        path: "asset/:assetId/notes",
        component: NotesListPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-notes:[[[assetName]]] — Notes` ||
            "Notes",
        },
      },
      {
        path: "asset/:assetId/positions",
        component: AssetPositionsPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-positions:[[[assetName]]] — Last positions` ||
            "Last positions",
        },
      },
      {
        path: "asset/:assetId/notes/:noteId/edit",
        component: NotesFormPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-asset-notes-edit:Notes — Edit` ||
            "Notes — Edit",
        },
      },
    ],
    ...
    children: [
      {
        ...
        component: MobileTerminalListPage,
        pathMatch: "full",
        data: {
          title:
            $localize`:@@ts-layout-mobileTerminal-list:Mobile Terminal — List` ||
            "Mobile Terminal - List",
        },
      },
      {
        path: "mobileTerminal/:mobileTerminalId",
        component: MobileTerminalShowPage,
        pathMatch: "full",
        data: {
          // tslint:disable-next-line:max-line-length
          title:
            $localize`:@@ts-layout-mobileTerminal-show:[[[mobileTerminalName]]] — Mobile Terminal information` ||
            "Mobile Terminal information",
        },
      },
      {
        path: "mobileTerminal/:mobileTerminalId/edit",
        component: MobileTerminalFormPage,
        pathMatch: "full",
        data: {
          // tslint:disable-next-line:max-line-length
          title:
            $localize`:@@ts-layout-mobileTerminal-edit:[[[mobileTerminalName]]] — Mobile Terminal edit` ||
            "Mobile Terminal edit",
        },
      },
      {
        path: "mobileTerminal/:mobileTerminalId/attachment-history",
        component: MobileTerminalAttachmentHistoryPage,
        pathMatch: "full",
        data: {
          // tslint:disable-next-line:max-line-length
          title:
            $localize`:@@ts-layout-mobileTerminal-attachment-history:[[[mobileTerminalName]]] — Mobile Terminal attachment history` ||
            "Mobile Terminal attachment history",
        },
      },
      {
        path: "mobileTerminal/:mobileTerminalId/history",
        component: MobileTerminalHistoryPage,
        pathMatch: "full",
        data: {
          // tslint:disable-next-line:max-line-length
          title:
            $localize`:@@ts-layout-mobileTerminal-history:[[[mobileTerminalName]]] — Mobile Terminal history` ||
